...
pomExtra :=
  <url>https://github.com/hypertino/wallet-service</url>
    <licenses>
      <license>
        <name>BSD-style</name>
    ...
    <scm>
      <url>git@github.com:hypertino/wallet-service.git</url>
      <connection>scm:git:git@github.com:hypertino/wallet-service.git</connection>
    </scm>
    <developers>
      <developer>
        <id>maqdev</id>
